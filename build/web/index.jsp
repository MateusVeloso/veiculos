<%-- 
    Document   : index
    Created on : 05/04/2019, 13:08:17
    Author     : mateus
--%>
                    ...
                    <div class="container">
                        <div class="row">
                            <div class="col d-flex flex-row">
                                <div class="top_bar_contact_item"><div class="top_bar_icon"><img src="images/phone.png" alt=""></div>+55 081 9 99707019</div>
                                <div class="top_bar_contact_item"><div class="top_bar_icon"><img src="images/mail.png" alt=""></div><a href="mailto:fastsales@gmail.com">mateusveloso.developer@gmail.com</a></div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-2 col-sm-3 col-3 order-1">
                                <div class="logo_container">
                                    <div class="logo"><a href="#">ADVeículos</a></div>
                                </div>
                            </div>
                                    ...
                                    <div class="header_search_content">
                                        <div class="header_search_form_container">
                                            <form action="#" class="header_search_form clearfix">
                                                <input type="search" required="required" class="header_search_input" placeholder="Encontrar um veículo...">
                                                <div class="custom_dropdown">
                                                    <div class="custom_dropdown_list">
                                                        ...
                                                        <ul class="custom_list clc">
                                                            ...
                                                            <li><a class="clc" href="#">Carros</a></li>
                                                            <li><a class="clc" href="#">Motos</a></li>
                                                            <li><a class="clc" href="#">Barcos</a></li>
                                                        </ul>
                                                    </div>
                                                </div>
                            ...
                            <div class="col">
                                <div class="main_nav_content d-flex flex-row">
                                    ...
                                    <div class="cat_menu_container">
                                        ...
                                        <ul class="cat_menu">
                                            <li><a href="#">Carros<i class="fas fa-chevron-right ml-auto"></i></a></li>
                                            <li><a href="#">Motos<i class="fas fa-chevron-right"></i></a></li>
                                            <li><a href="#">Vans<i class="fas fa-chevron-right"></i></a></li>
                                            <li><a href="#">Caminhões<i class="fas fa-chevron-right"></i></a></li>
                                            <li><a href="#">Barcos<i class="fas fa-chevron-right"></i></a></li>
                                            <li><a href="#">Aeronaves<i class="fas fa-chevron-right"></i></a></li>
                                            <li><a href="#">Ônibus<i class="fas fa-chevron-right"></i></a></li>
<!--                                            <li class="hassubs">
                                                <a href="#">Barcos<i class="fas fa-chevron-right"></i></a>
                                                <ul>
                                                    <li class="hassubs">
...
<!--                                            <li class="hassubs">
                                            ...
                                            <!--<li><a href="blog.html">Blog<i class="fas fa-chevron-down"></i></a></li>-->
                                            <li><a href="contact.html">Contato<i class="fas fa-chevron-down"></i></a></li>
                                        </ul>
                                    </div>
            ...
            <div class="banner">
                ...
                <div class="container fill_height">
                    <div class="row fill_height">
                        <div class="banner_product_image"><img src="images/audi.png" alt="" style="width: 630px;margin-top: 70px;"></div>
                        <div class="col-lg-5 offset-lg-4 fill_height">
                            <div class="banner_content">
                                <h1 class="banner_text">Nova era de carros</h1>
                                <div class="banner_price"><span>R$130.000,00</span></div>
                                <div class="banner_price" style="margin-top: 0px;">R$110.000,00</div>
                                <div class="banner_product_name">Audi XXX</div>
                                <div class="button banner_button"><a href="#">Ver detalhes</a></div>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="container">
                    <div class="row">
                        <div class="col d-flex flex-lg-row flex-column align-items-center justify-content-start">
                            ...
                            <div class="deals">
                                <div class="deals_title">Mega ofertas</div>
                                <div class="deals_slider_container">
                                    ...
                                    <div class="owl-carousel owl-theme deals_slider">
                                        ...
                                        <div class="owl-item deals_item">
                                            <div class="deals_image"><img src="images/honda_civic.png" alt=""></div>
                                            <div class="deals_content">
                                                <div class="deals_info_line d-flex flex-row justify-content-start">
                                                    <div class="deals_item_category"><a href="#">Honda</a></div>
                                                    <div class="deals_item_price_a ml-auto">R$30.000,00</div>
                                                </div>
                                                <div class="deals_info_line d-flex flex-row justify-content-start">
                                                    <div class="deals_item_name">Honda Civic</div>
                                                    <div class="deals_item_price ml-auto">R$27.000,00</div>
                                                </div>
                                                <div class="available">
                                                    <div class="available_line d-flex flex-row justify-content-start">
                                                        <div class="available_title">Favorito: <span>6</span></div>
                                                ...
                                                <div class="deals_timer d-flex flex-row align-items-center justify-content-start">
                                                    <div class="deals_timer_title_container">
                                                        <div class="deals_timer_title">Acaba em:</div>
                                                        <!--<div class="deals_timer_subtitle">Acaba em:</div>-->
                                                    </div>
                                        ...
                                        <!-- Deals Item -->
                                        <div class="owl-item deals_item">
                                            <div class="deals_image"><img src="images/palio.png" alt=""></div>
                                            <div class="deals_content">
                                                <div class="deals_info_line d-flex flex-row justify-content-start">
                                                    <div class="deals_item_category"><a href="#">Fiat</a></div>
                                                    <div class="deals_item_price_a ml-auto">R$20.000,00</div>
                                                </div>
                                                <div class="deals_info_line d-flex flex-row justify-content-start">
                                                    <div class="deals_item_name">Palio</div>
                                                    <div class="deals_item_price ml-auto">R$17.000,00</div>
                                                </div>
                                                <div class="available">
                                                    <div class="available_line d-flex flex-row justify-content-start">
                                                        <div class="available_title">Favorito: <span>6</span></div>
                                        ...
                                        <div class="featured_slider slider">
                                            ...
                                            <div class="featured_slider_item">
                                                ...
                                                <div class="product_item discount d-flex flex-column align-items-center justify-content-center text-center">
                                                    <div class="product_image d-flex flex-column align-items-center justify-content-center"><img src="images/palio.png" alt=""></div>
